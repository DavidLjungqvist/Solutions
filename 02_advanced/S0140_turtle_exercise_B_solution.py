...
def coloured_triangle(length, colour="black"):
    for x in range(3):
        tom.pencolor(colour)
        tom.forward(length)
        tom.left(120)
...
def circles(size):
    ...
    for x in range(10):
        tom.circle(size)
        tom.penup()
        tom.goto(((x+1)*50)-250, 0)
        tom.pendown()


def draw_square_at(lenght, x, y):
    tom.speed(8)
    tom.penup()
    tom.goto(x, y)
    tom.pendown()
    for x in range(4):
        ...
        tom.right(90)  # turn 45 degrees left
...
def draw_grid(rows, cols, size):
    ...
    for col in range(cols):
        tom.penup()
        tom.goto(-size*2.5, (-(col)+2)*size)
        tom.pendown()
        for row in range(rows):
            for i in range(4):
                tom.forward(size)  # move 50 pixels
                tom.right(90)  # turn 45 degrees left
            tom.forward(size)


def draw_house(size, colour="black"):
    tom.pencolor(colour)
    for i in range(4):
        tom.forward(size)
        tom.right(90)
...
# move_to(-50, 200)
# triangle(50)
# coloured_triangle(50, "green")
# circles(25)
# draw_square_at(25, 100, 200)
# draw_grid(5, 5, 50)
draw_house(80, "black")
